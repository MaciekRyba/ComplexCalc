...
namespace ComplexCalculator
{
    ...
    public class Service1 : ComplexServices
    {
        ...
        {
            string multiplyResult = division_method(FirstComplex.RealValueOperation, SecondComplex.RealValueOperation, FirstComplex.ImaginryValueOperation, SecondComplex.ImaginryValueOperation);
        ...
        public string Multiply(double real1, double imaginary1, double real2, double imaginary2)
        {
            ...
            string multiplyResult = division_method(real1, real2, imaginary1, imaginary2);
            return multiplyResult;
        }

        public string Subtract(ComplexType FirstComplex, ComplexType SecondComplex)
        {
            string subtractResult = division_method(FirstComplex.RealValueOperation, SecondComplex.RealValueOperation, FirstComplex.ImaginryValueOperation, SecondComplex.ImaginryValueOperation);
            return subtractResult;
        }

        public string Subtract(double real1, double imaginary1, double real2, double imaginary2)
        {
            string subtractResult = add_method(real1, real2, imaginary1, imaginary2);
            return subtractResult;
        }
